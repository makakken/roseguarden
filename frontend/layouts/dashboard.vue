      ...
      <v-app id="inspire" class="app">
        ...
        <v-content>
          ...
          <v-footer height="auto" class="white pa-3 app--footer">
            <span class="caption"> 
              <b> Roseguarden:</b>
              <a href="https://gitlab.com/roseguarden">https://gitlab.com/roseguarden</a>,
        ...
        -->
        <v-footer  min-height="60px" class="app grey darken-2 pa-3 footerclass white--text">
            <cookie-law theme="dark-lime" buttonText="I accept">
            <div slot="message">
              This site uses cookies. Only necessary cookies will be stored. For more information <router-link to="privacy">Click here</router-link>
            </div>            
            </cookie-law>          
            <v-row dense no-gutters justify="center">   
              ...
              >
                <strong>Powered by roseguarden  - &copy; {{ new Date().getFullYear() }} </strong>
              </v-btn>
