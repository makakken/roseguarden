  ...
  export default {
    ...
    watch: {
      ...
      viewStates(newValue, oldValue) {
        ...
        if(newValue['nodes/nodeClasses'] === 'ready')  {
          this.classes = viewParser.parseEntries('nodes/nodeClasses', this.viewDictionary);
          this.classesHeaders = viewParser.parseHeader('nodes/nodeClasses', this.viewDictionary);
        } 

      }
    },
    mounted () {
      let getViewAction = [actionBuilder.newGetViewAction("nodes", "nodeClasses")];
