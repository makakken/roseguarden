                  ...
                  <v-row align="center" justify="center">
                    ...
                    >
                      <v-progress-circular
                        ...
                        color="primary"
                      ></v-progress-circular>
                      <v-icon v-else-if="error" color="red" :size="60"
                        >mdi-close-circle-outline</v-icon
                      >
                      <v-icon v-else color="green" :size="60"
                    ...
                    <v-col
                      ...
                      justify="center"
                    >
                      <span class="text-left text-xs-center title">
                        {{ info }}
                      </span>
                    </v-col>
                  </v-row>
...
export default {
  ...
  mounted() {
    let runActionlinkAction = [
      actionBuilder.newRequestActionLinkAction(this.actionhash),
    ];
