    ...
    data () {
      return {
        ...
        rules: {
          ...
          requestKey_digits:  v => /([0-9A-Za-z]{12})/.test(v) || 'The request key have to have 12 characters',
          requestKey_length: v => v.length == 12 || 'The request key have to have 12 characters',
          pin: [
