...
export default {
  ...
  methods: {
    ...
    onRemoveGroup() {
      let removeViewEntryAction = [
        actionBuilder.newRemoveDataViewEntryAction(
          "access",
          "accessGroupsList",
          this.selectedGroup
        ),
    ...
    requestNewGroup() {
      let createViewEntryAction = [
        actionBuilder.newCreateViewAction("access", "accessGroupsList", {
  ...
  watch: {
    viewStates(newValue, oldValue) {
      if (newValue["access/accessGroupsList"] === "ready") {
        ...
        this.groupsProps = viewParser.parseProperties(
          "access/accessGroupsList",
          this.viewDictionary
        );
      ...
      if (newValue["access/spacesList"] === "ready") {
        this.spaces = viewParser.parseEntries(
          "access/spacesList",
          this.viewDictionary
        );
      }
