...
association_table_user_filepermissiongroup = db.Table('filepermissiongroup_user_map',
...
class FilePermissionGroup(db.Model):
    ...
    users = db.relationship("User", backref="filepermission_groups", secondary=association_table_user_filepermissiongroup, lazy='subquery',)

    def __init__(self, name):
        self.name = name

association_table_filepermission_filepermissiongroup = db.Table('filepermission_filepermissiongroup_map',
    db.Column('filepermissiongroup_id', db.Integer, db.ForeignKey('filepermissiongroups.id')),
...
class FilePermission(db.Model):
    ...
    groups = db.relationship("FilePermissionGroup", backref="filepermissions", secondary=association_table_filepermission_filepermissiongroup, lazy='subquery',)    
    ldap_group = db.Column(db.String(64), default= "")
    ldap = db.Column(db.Boolean, default=False)
    name = db.Column(db.String(64), default= "")
...
association_table_filepermission_filestorage = db.Table('filepermission_filestorage_map',
...
class FileStorage(db.Model):
    ...
    permissions = db.relationship("FilePermission", backref="filestorages", secondary=association_table_filepermission_filestorage, lazy='subquery',)
    def __repr__(self):
