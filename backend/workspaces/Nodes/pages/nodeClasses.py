...
class NodeClasses(Page):
    title = "Node classes"  # Shown label of the page in the menu
    group = "Nodes"  # groupname multiple pages
    icon = "device_hub"  # icon (in typeset of material design icons)
    route = "/nodes/classes"  # routing
