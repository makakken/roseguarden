...
""" The user access account page
"""


class AccountAccess(Page):
    title = "Space Access"  # Shown label of the page in the menu
    group = "User"  # groupname multiple pages
    icon = "lock"  # icon (in typeset of material design icons)
    route = "/access/account"  # routing
