...
class AssignUserAuthentictor(Action):
    ...
    def handle(self, action, user, workspace, actionManager ):
        ...
        if user_to_assign is None:
            notification_action = webclientActions.NotificationAction.generate("Failed to assign authenticator to user.", "error")
            return 'success', [notification_action], {'succeed' : False, 'message' : "Failed to assign authenticator to user."}            
