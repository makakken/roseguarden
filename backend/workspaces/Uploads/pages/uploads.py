...
from core import db
""" The upload management page
"""


class Uploads(Page):
    title = 'Uploads'  # Shown label of the page in the menu
    group = 'Admin'  # groupname multiple pages
    icon = 'file_upload'  # icon (in typeset of material design icons)
    route = '/admin/uploads'  # routing
    builder = 'frontend'  # page get build by the client (frontend)
    rank = 1.7  # ranks (double) the page higher values are at the top of the menu
